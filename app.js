...
// Igual formatMonsterName, mas já aplicando a correção de grafia (MONSTER_NAME_FIXES)
// pra não mostrar o nome errado escrito embaixo do monstro.
...
var TYPE_COLORS = {
  common:'#b7b48c',dragon:'#7c6cff',earth:'#e8b84b',evil:'#a6836e',
  fire:'#ff6a45',ice:'#5fe0d8',lightning:'#ffd84a',mythic:'#ff7eb6',
  spirit:'#9c7eea',water:'#4fa3ff',wind:'#8fe0a8',umbral:'#9855e8'
};
var BOOK_BG = {
...
function openMonsterInfo(lcName) {
  ...
  var typeColor = TYPE_COLORS[type] || '#7cf5c4';
