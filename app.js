...
const TYPE_PARTICLES = {
  fire:      { count: 16, shapes: ['spark','orb'],   sizeMin: 3,  sizeMax: 9,  colors: ['#ff8a3d','#ffcf6b','#ff5a3c'] },
  ice:       { count: 14, shapes: ['shard','orb'],   sizeMin: 3,  sizeMax: 8,  colors: ['#bdf2f9','#7fd8e6','#e8fbff'] },
  water:     { count: 14, shapes: ['orb','shard'],   sizeMin: 4,  sizeMax: 10, colors: ['#6fc2ff','#3f7fc9','#bfe6ff'] },
  earth:     { count: 12, shapes: ['cell','orb'],    sizeMin: 4,  sizeMax: 11, colors: ['#c99a45','#8a6a30','#e0bd75'] },
  wind:      { count: 16, shapes: ['shard','cell'],  sizeMin: 2,  sizeMax: 7,  colors: ['#c9f2d3','#6fae7a','#eafff0'] },
  lightning: { count: 18, shapes: ['spark','shard'], sizeMin: 2,  sizeMax: 7,  colors: ['#fff3a0','#e3b93f','#fffde0'] },
  dragon:    { count: 14, shapes: ['orb','shard'],   sizeMin: 3,  sizeMax: 9,  colors: ['#7fa6ff','#4f7fd1','#bcd2ff'] },
  spirit:    { count: 14, shapes: ['orb','cell'],    sizeMin: 3,  sizeMax: 9,  colors: ['#b3c8ea','#6f97c9','#eef4ff'] },
  evil:      { count: 12, shapes: ['cell','shard'],  sizeMin: 3,  sizeMax: 9,  colors: ['#a98fcf','#5a4a72','#6b5a86'] },
  mythic:    { count: 16, shapes: ['orb','spark'],   sizeMin: 3,  sizeMax: 10, colors: ['#f6a8c6','#d9799a','#ffe1ee'] },
  umbral:    { count: 14, shapes: ['cell','orb'],    sizeMin: 3,  sizeMax: 9,  colors: ['#9096b0','#565b70','#c6cbe0'] },
  common:    { count: 10, shapes: ['orb','cell'],    sizeMin: 3,  sizeMax: 8,  colors: ['#d8d0a8','#a9a173','#efe9cf'] }
};
...
function renderSkillBookContent(skill, showUpgrade) {
  ...
  document.getElementById('sb-page-left').style.backgroundImage = "url('"+cardBg+"')";
